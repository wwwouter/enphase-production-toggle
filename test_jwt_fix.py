...
async def test_jwt_authentication():
    ...
    username = "your_enphase_email@example.com"  # Replace with your Enphase account email
...
if __name__ == "__main__":
    ...
    print("Please update the credentials in test_jwt_fix.py and uncomment the test line.")